...
import { Flex, FlexProps, Image, useIsDarkMode } from '@l.x/ui/src'
import { Jiggly } from '@l.x/ui/src/animations'
...
const OnboardingAnimation = ({
  ...
  const lxLogoScale = useSharedValue(1.5)
  const animatedStyle = useAnimatedStyle(() => ({ transform: [{ scale: lxLogoScale.value }] }), [lxLogoScale])

  useEffect(() => {
    lxLogoScale.value = withDelay(
      LOGO_SCALE_DELAY,
      withTiming(1, {
