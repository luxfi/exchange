...
import { isPermit2 } from '@luxfi/wallet/src/components/dappRequests/types/Permit2Types'
import { useTypedDataSections } from '@luxfi/wallet/src/features/dappRequests/hooks/useTypedDataSections'
 ...
 * Supports permit2, nonstandard, standard typed data formats, and LX swaps
 */
export function DappSignTypedDataContent({
  ...
  // Get transaction sections - handles both LX and regular typed data via Blockaid
