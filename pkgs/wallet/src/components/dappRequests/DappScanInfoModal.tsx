...
import { FileListCheck } from '@luxfi/ui/src/components/icons'
import { defaultHitslop, zIndexes } from '@luxfi/ui/src/theme'
...
export function DappScanInfoModal({ isOpen, onClose, title, description }: DappScanInfoModalProps): JSX.Element {
  ...
  const handleLearnMore = useCallback((): void => {
    openUri({ uri: lxUrls.helpArticleUrls.dappProtectionInfo }).catch((e) => {
