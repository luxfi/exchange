...
import { addTransaction, updateTransaction } from '@l.x/lx/src/features/transactions/slice'
import { TransactionStatus } from '@l.x/lx/src/features/transactions/types/transactionDetails'
import { approveTransactionInfo, transactionDetails as txDetailsFixture } from '@l.x/lx/src/test/fixtures'
