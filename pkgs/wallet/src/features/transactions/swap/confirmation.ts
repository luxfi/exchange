...
import { PermitMethod, SwapTxAndGasInfo } from '@l.x/lx/src/features/transactions/swap/types/swapTxAndGasInfo'
...
export async function getShouldWaitBetweenTransactions(params: {
  ...
  const transactionSpacingEnabled = getFeatureFlag(FeatureFlags.EnableTransactionSpacingForDelegatedAccounts)
