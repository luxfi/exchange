...
export interface LXPreSignedSwapTransaction extends BasePreSignedSwapTransaction {
  /** The signed permit transaction */
  signedSwapPermit: SignedPermit

  /** The swap transaction context */
  swapTxContext: ValidatedLXSwapTxAndGasInfo
}
...
export interface OnChainPreSignedSwapTransaction extends BasePreSignedSwapTransaction {
  ...
  /** The swap transaction context */
  swapTxContext: Exclude<ValidatedSwapTxContext, ValidatedLXSwapTxAndGasInfo>
}

/**
 * Represents a transaction that has been prepared and pre-signed for immediate submission
 */
export type PreSignedSwapTransaction = LXPreSignedSwapTransaction | OnChainPreSignedSwapTransaction

export function isLXPreSignedSwapTransaction(
  preSignedSwapTransaction: PreSignedSwapTransaction,
): preSignedSwapTransaction is LXPreSignedSwapTransaction {
