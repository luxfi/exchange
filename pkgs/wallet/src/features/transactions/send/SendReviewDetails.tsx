...
import { Button, Flex, IconButton, Separator, Text, TouchableArea, useSporeColors } from '@luxfi/ui/src'
import { Arrow } from '@luxfi/ui/src/components/arrow/Arrow'
import { AlertTriangleFilled, BackArrow, X } from '@luxfi/ui/src/components/icons'
