...
import { ParsedWarnings, WarningAction } from '@l.x/lx/src/components/modals/WarningModal/types'
...
import { useTransactionGasFee, useTransactionGasWarning } from '@l.x/lx/src/features/gas/hooks'
import { useMaxAmountSpend } from '@l.x/lx/src/features/gas/hooks/useMaxAmountSpend'
import { useFormattedWarnings } from '@l.x/lx/src/features/transactions/hooks/useParsedTransactionWarnings'
