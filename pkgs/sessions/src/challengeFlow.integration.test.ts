...
describe('Challenge Flow Integration Tests', () => {
  ...
  it('initializes a session with needChallenge: true and completes challenge flow', async () => {
    ...
    const originalInit = mockEndpoints['/lx.platformservice.v1.SessionService/InitSession']
    mockEndpoints['/lx.platformservice.v1.SessionService/InitSession'] = async (
      request,
      headers,
    ...
    const originalChallenge = mockEndpoints['/lx.platformservice.v1.SessionService/Challenge']
    mockEndpoints['/lx.platformservice.v1.SessionService/Challenge'] = async (
      request,
      headers,
    ...
    const originalVerify = mockEndpoints['/lx.platformservice.v1.SessionService/Verify']
    mockEndpoints['/lx.platformservice.v1.SessionService/Verify'] = async (
      request,
      headers,
  ...
  it('handles challenge retry when upgrade fails', async () => {
    ...
    mockEndpoints['/lx.platformservice.v1.SessionService/Verify'] = async (): Promise<VerifyResponse> => {
      verifyAttempts++
      if (verifyAttempts === 1) {
  ...
  it('submits empty solution when solver throws, allowing verify-retry fallback', async () => {
    ...
    mockEndpoints['/lx.platformservice.v1.SessionService/Verify'] = async (request): Promise<VerifyResponse> => {
  ...
  it('Turnstile solver fails → empty verify → retry → Hashcash succeeds end-to-end', async () => {
    ...
    mockEndpoints['/lx.platformservice.v1.SessionService/Challenge'] = async (): Promise<ChallengeResponse> => {
