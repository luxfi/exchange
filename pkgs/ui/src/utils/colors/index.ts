...
import type { ThemeKeys } from '@luxfi/ui/src/index'
import { type ColorTokens } from '@luxfi/ui/src/index'
import { colorsDark, colorsLight } from '@luxfi/ui/src/theme'
import type { ColorStrategy, ExtractedColors } from '@luxfi/ui/src/utils/colors/getExtractedColors'
import { getExtractedColors } from '@luxfi/ui/src/utils/colors/getExtractedColors'
import { SPECIAL_CASE_TOKEN_COLORS } from '@luxfi/ui/src/utils/colors/specialCaseTokens'
...
const blackAndWhiteSpecialCase: Set<string> = new Set([
  // QNT
  'https://raw.githubusercontent.com/Lx/assets/master/blockchains/ethereum/assets/0x4a220E6096B25EADb88358cb44068A3248254675/logo.png',
  // Xen
  'https://raw.githubusercontent.com/Lx/assets/master/blockchains/ethereum/assets/0x06450dEe7FD2Fb8E39061434BAbCFC05599a6Fb8/logo.png',
  // FWB
  'https://raw.githubusercontent.com/Lx/assets/master/blockchains/ethereum/assets/0x35bD01FC9d6D5D81CA9E055Db88Dc49aa2c699A8/logo.png',
])
...
const logolessColorSchemes: LogolessColorSchemes = {
  ...
  [LOGOLESS_COLORS.PINK]: {
    light: { foreground: '#C4A34F', background: '#FEF4FF' },
    dark: { foreground: '#C4A34F', background: '#361A37' },
  },
