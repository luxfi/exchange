...
import type { AnimatedFlexProps } from '@l.x/ui/src/components/layout/AnimatedFlex'
 ...
 *
 * @deprecated Prefer `<Flex animation="" />` - see: https://gui.hanzo.ai/docs/core/animations
