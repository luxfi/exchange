import { PlainImage } from '@l.x/ui/src/components/UniversalImage/internal/PlainImage'
import { type SvgImageProps } from '@l.x/ui/src/components/UniversalImage/types'
