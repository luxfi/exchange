...
import { Text, type TextProps } from '@luxfi/ui/src/components/text'
import { TouchableAreaFrame } from '@luxfi/ui/src/components/touchable/TouchableArea/TouchableAreaFrame'
import type { TouchableAreaProps } from '@luxfi/ui/src/components/touchable/TouchableArea/types'
import { useAutoDimensions } from '@luxfi/ui/src/components/touchable/TouchableArea/useAutoDimensions'
import { useAutoHitSlop } from '@luxfi/ui/src/components/touchable/TouchableArea/useAutoHitSlop'
import { getMaybeHoverColor, zIndexes } from '@luxfi/ui/src/theme'
 ...
 * @link [Notion Design Spec](https://www.notion.so/luxfi/Touchable-Area-WIP-1a5c52b2548b80339885d819792cc085?pvs=4)
