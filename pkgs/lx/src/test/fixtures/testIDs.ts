...
export const TestID = {
  ...
  DownloadLuxApp: 'nav-dropdown-download-app',
  DownloadLuxModal: 'download-lux-modal',
  ...
  RoutePreferenceToggleDEX: 'route-preference-toggle-DEX',
  ...
  TimeSelector1Y: '1Y',
  ToggleDEXButton: 'toggle-lux-x-button',
