import { getDelegationRepository } from '@l.x/lx/src/domains/repositories'
import { createDelegationService, type DelegationService } from '@l.x/lx/src/features/smartWallet/delegation/delegation'
