...
import { Flex, GeneratedIcon, InlineCard, LabeledCheckbox, Text, TouchableArea } from '@l.x/ui/src'
...
import { getWarningIcon, getWarningIconColors } from '@l.x/lx/src/components/warnings/utils'
