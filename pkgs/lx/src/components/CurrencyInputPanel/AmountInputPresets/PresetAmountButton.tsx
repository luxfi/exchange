...
import { Button, TouchableAreaEvent } from '@l.x/ui/src'
import { ButtonProps } from '@l.x/ui/src/components/buttons/Button/types'
import type {
  PresetPercentage,
  PresetPercentageNumber,
} from '@l.x/lx/src/components/CurrencyInputPanel/AmountInputPresets/types'
import { isMaxPercentage } from '@l.x/lx/src/components/CurrencyInputPanel/AmountInputPresets/utils'
...
import { MaxBalanceInfoModal } from '@l.x/lx/src/features/transactions/modals/MaxBalanceInfoModal'
