...
import { fireEvent, render, screen, waitFor, waitForElementToBeRemoved } from '@l.x/lx/src/test/test-utils'
...
vi.mock('@hanzo/gui', async (importOriginal) => {
  const actualGui = await importOriginal<typeof import('@hanzo/gui')>()
