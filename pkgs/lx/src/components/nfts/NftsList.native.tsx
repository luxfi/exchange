...
import { AnimatedBottomSheetFlashList, AnimatedFlashList } from '@l.x/ui/src/components/AnimatedFlashList/AnimatedFlashList'
...
import { EMPTY_NFT_ITEM, ESTIMATED_NFT_LIST_ITEM_SIZE, HIDDEN_NFTS_ROW } from '@l.x/lx/src/features/nfts/constants'
