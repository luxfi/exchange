...
import { Button, Flex, Image, Text, TouchableArea } from '@l.x/ui/src'
import { GlobeFilled } from '@l.x/ui/src/components/icons/GlobeFilled'
import { X } from '@l.x/ui/src/components/icons/X'
import { borderRadii, iconSizes, zIndexes } from '@l.x/ui/src/theme'
    ...
    <Modal name={ModalName.QRCodeNetworkInfo} isModalOpen={isShowingModal} onClose={closeModal}>
      <Flex gap="$spacing12" px="$padding16" pb="$spacing4" alignItems="center" mt="$gap12">
        ...
        <LearnMoreLink
          ...
          url={lxUrls.helpArticleUrls.supportedNetworks}
        />
