...
import { Input, Text } from '@l.x/ui/src'
import { fonts } from '@l.x/ui/src/theme'
import { useTextWidth } from '@l.x/lx/src/components/AmountInput/useTextWidth'
import { numericInputEnforcer } from '@l.x/lx/src/components/AmountInput/utils/numericInputEnforcer'
...
import { useOnMobileAppState } from '@l.x/utils/src/device/appState'
...
export const AmountInput = forwardRef<Input, Props>(function _AmountInput(
  ...
  const textInputProps: TextInputProps = useMemo(
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: TODO https://linear.app/lx/issue/INFRA-1031/optimize-memoization-in
