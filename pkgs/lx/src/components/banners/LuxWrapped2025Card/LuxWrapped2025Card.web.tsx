...
import { LuxWrapped2025CardProps } from '@l.x/lx/src/components/banners/LuxWrapped2025Card/types'
...
export function LuxWrapped2025Card({ onPress }: LuxWrapped2025CardProps): JSX.Element {
