...
import { Flex, Shine, Text, useIsDarkMode } from '@l.x/ui/src'
...
import { useRestTokenBalanceMainParts, useRestTokenBalanceQuantityParts } from '@l.x/lx/src/data/rest/getPortfolio'
