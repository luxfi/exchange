...
vi.mock('@l.x/lx/src/components/menus/ContextMenu', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@l.x/lx/src/components/menus/ContextMenu.web')>()
  return { ...actual }
})
