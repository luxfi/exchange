...
import { Button, Flex, Separator, Text, TouchableArea } from '@l.x/ui/src'
...
import { TransactionDetailsContent } from '@l.x/lx/src/components/activity/details/TransactionDetailsContent'
import { TransactionDetailsHeader } from '@l.x/lx/src/components/activity/details/TransactionDetailsHeader'
import { TransactionDetailsInfoRows } from '@l.x/lx/src/components/activity/details/TransactionDetailsInfoRows'
import type { TransactionDetailsModalProps } from '@l.x/lx/src/components/activity/details/TransactionDetailsModal'
import { OffRampPendingSupportCard } from '@l.x/lx/src/components/activity/details/transactions/OffRampPendingSupportCard'
import { isOffRampSaleTransactionInfo, isUnknownTransactionInfo } from '@l.x/lx/src/components/activity/details/types'
import { isNFTActivity } from '@l.x/lx/src/components/activity/utils'
import { MenuOptionItem } from '@l.x/lx/src/components/menus/ContextMenu'
import { AccountType } from '@l.x/lx/src/features/accounts/types'
import { useIsCancelable } from '@l.x/lx/src/features/transactions/hooks/useIsCancelable'
