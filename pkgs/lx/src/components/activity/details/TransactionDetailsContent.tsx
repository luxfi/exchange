...
import { ApproveTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/ApproveTransactionDetails'
import { AuctionTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/AuctionTransactionDetails'
import { BridgeTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/BridgeTransactionDetails'
import { LiquidityTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/LiquidityTransactionDetails'
import { NftTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/NftTransactionDetails'
import { OffRampTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/OffRampTransactionDetails'
import { OnRampTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/OnRampTransactionDetails'
import { PlanTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/PlanTransactionDetails'
import { SwapTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/SwapTransactionDetails'
import { TransferTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/TransferTransactionDetails'
import { WrapTransactionDetails } from '@luxexchange/lx/src/components/activity/details/transactions/WrapTransactionDetails'
