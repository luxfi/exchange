...
import { Text, LXText, useSporeColors } from '@l.x/ui/src'
...
import { fonts, NATIVE_LINE_HEIGHT_SCALE, zIndexes } from '@l.x/ui/src/theme'
import { NetworkCostTooltip, NetworkCostTooltipDEX } from '@l.x/lx/src/components/gas/NetworkCostTooltip'
...
import { NetworkCostBanner } from '@l.x/lx/src/features/smartWallet/banner/NetworkCostBanner'
