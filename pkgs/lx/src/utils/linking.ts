...
import { NATIVE_TOKEN_PLACEHOLDER } from '@l.x/lx/src/constants/addresses'
import { lxUrls } from '@l.x/lx/src/constants/urls'
import { getChainInfo } from '@l.x/lx/src/features/chains/chainInfo'
import { UniverseChainId } from '@l.x/lx/src/features/chains/types'
import { toGraphQLChain, toLxWebAppLink } from '@l.x/lx/src/features/chains/utils'
import { BACKEND_NATIVE_CHAIN_ADDRESS_STRING } from '@l.x/lx/src/features/search/utils'
import { ServiceProviderInfo } from '@l.x/lx/src/features/transactions/types/transactionDetails'
import { currencyIdToChain, currencyIdToGraphQLAddress, isNativeCurrencyAddress } from '@l.x/lx/src/utils/currencyId'
import { canOpenURL, openURL } from '@l.x/lx/src/utils/link'
...
export function getTokenUrl(currencyId: string, addMobileUTMTags: boolean = false): string | undefined {
  ...
  const network = toLuxWebAppLink(chainId)
  try {
