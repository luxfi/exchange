import 'lx/src/i18n/locales/@types/i18next'

import i18n from 'i18next'
import { initReactI18next } from 'react-i18next'
import enUS from 'lx/src/i18n/locales/source/en-US.json'
import esES from 'lx/src/i18n/locales/translations/es-ES.json'
import frFR from 'lx/src/i18n/locales/translations/fr-FR.json'
import idID from 'lx/src/i18n/locales/translations/id-ID.json'
import jaJP from 'lx/src/i18n/locales/translations/ja-JP.json'
import nlNL from 'lx/src/i18n/locales/translations/nl-NL.json'
import ptPT from 'lx/src/i18n/locales/translations/pt-PT.json'
import ruRU from 'lx/src/i18n/locales/translations/ru-RU.json'
import trTR from 'lx/src/i18n/locales/translations/tr-TR.json'
import viVN from 'lx/src/i18n/locales/translations/vi-VN.json'
import zhCN from 'lx/src/i18n/locales/translations/zh-CN.json'
import zhTW from 'lx/src/i18n/locales/translations/zh-TW.json'
import { MissingI18nInterpolationError } from 'lx/src/i18n/shared'
