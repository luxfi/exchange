...
export const CONVERSION_LEADS_EXTERNAL_COOKIE_DOMAIN = __DEV__ ? 'localhost' : '.lux.exchange'

export const DEV_CONVERSION_PROXY_API_BASE_URL =
  process.env.REACT_APP_DEV_ENTRY_GATEWAY_URL || 'https://gw.lux.exchange/conversion'
export const STAGING_CONVERSION_PROXY_API_BASE_URL =
  process.env.REACT_APP_STAGING_ENTRY_GATEWAY_URL || 'https://gw.lux.exchange/conversion'
export const PROD_CONVERSION_PROXY_API_BASE_URL =
