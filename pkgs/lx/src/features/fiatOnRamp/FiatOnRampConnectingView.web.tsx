...
import { AnimatePresence, Flex, Image, Text } from '@l.x/ui/src'
import { LX_LOGO_LARGE } from '@l.x/ui/src/assets'
      ...
      <AnimatePresence>
        <Flex centered grow style={{ marginBottom: insets.bottom }}>
          <Flex row gap="$spacing16" pb="$spacing16">
            <Flex alignItems="center" justifyContent="center" style={ServiceProviderLogoStyles.lxLogoWrapper}>
              <Image height={iconSizes.icon64} source={LX_LOGO_LARGE} width={iconSizes.icon64} />
            </Flex>
            {serviceProviderLogo}
          </Flex>
