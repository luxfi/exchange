...
import {
  ...
  WarningLabel,
  WarningSeverity,
} from '@l.x/lx/src/components/modals/WarningModal/types'
import { type PollingInterval } from '@l.x/lx/src/constants/misc'
import { nativeOnChain } from '@l.x/lx/src/constants/tokens'
import { useGasFeeQuery } from '@l.x/lx/src/data/apiClients/luxApi/useGasFeeQuery'
import { useIsSmartContractAddress } from '@l.x/lx/src/features/address/useIsSmartContractAddress'
import { useEnabledChains } from '@l.x/lx/src/features/chains/hooks/useEnabledChains'
import { UniverseChainId } from '@l.x/lx/src/features/chains/types'
import { getChainGasToken, useChainGasToken } from '@l.x/lx/src/features/gas/hooks/useChainGasToken'
import { convertTempoGasFeeForDisplay } from '@l.x/lx/src/features/gas/tempo'
import { getActiveGasStrategy, hasSufficientGasBalance } from '@l.x/lx/src/features/gas/utils'
...
import { type DerivedSendInfo } from '@l.x/lx/src/features/transactions/send/types'
