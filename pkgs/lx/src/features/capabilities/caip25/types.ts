...
} from '@l.x/lx/src/features/capabilities/caip25/constants'
...
export type CAIP372WalletInfo = {
  ...
  name: string
  /**
   * A URI pointing to an image asset representing the wallet. The image SHOULD be square, with a minimum resolution of 96×96px. SVG or PNG formats are recommended. The asset SHOULD be optimized for display on both light and dark backgrounds.
   */
  icon?: string
  /**
