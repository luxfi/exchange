...
import { SignerInfo, waitForFlashbotsProtectReceipt } from '@l.x/lx/src/features/providers/FlashbotsCommon'
import { createFlashbotsRpcClient } from '@l.x/lx/src/features/providers/FlashbotsRpcClient'
...
describe('FlashbotsRpcClient', () => {
  ...
  describe('createFlashbotsRpcClient', () => {
    it('should create a client with the correct URL and parameters', async () => {
      ...
      // Check origin ID
      expect(requestUrl).toContain('originId=lxwallet')
