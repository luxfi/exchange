...
import { getFiatCurrencyCode } from '@l.x/lx/src/features/fiatCurrency/hooks'
import { TrimTrailingZerosParams } from '@l.x/lx/src/features/fiatCurrency/priceChart/formatters/shared/types'
