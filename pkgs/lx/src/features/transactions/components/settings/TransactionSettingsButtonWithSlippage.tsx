...
import { SettingsWarning } from '@l.x/ui/src/components/icons/SettingsWarning'
...
import { SLIPPAGE_LOW_TOLERANCE_LP } from '@l.x/lx/src/features/transactions/components/settings/settingsConfigurations/slippage/SlippageLPWarning'
...
import { TransactionSettingsButtonWithTooltip } from '@l.x/lx/src/features/transactions/components/settings/TransactionSettingsButton'
import { getSlippageWarningColor } from '@l.x/lx/src/features/transactions/swap/utils/styleHelpers'
import { isExtensionApp, isMobileWeb, isWebApp } from '@l.x/utils/src/platform'
