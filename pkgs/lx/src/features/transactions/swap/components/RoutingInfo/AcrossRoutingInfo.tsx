...
import AcrossLogoFull from '@l.x/ui/src/assets/logos/svg/across-logo-full.svg'
    ...
    () =>
      isMobileApp ? (
        <Flex centered gap="$spacing16">
          <LearnMoreLink textVariant="buttonLabel3" url={lxUrls.helpArticleUrls.acrossRoutingInfo} />
