...
import type { ColorTokens } from '@l.x/ui/src'
import { Flex, PlusMinusButton, PlusMinusButtonType, Text, TouchableArea, useSporeColors } from '@l.x/ui/src'
...
import { BottomSheetTextInput } from '@l.x/lx/src/components/modals/Modal'
import { LearnMoreLink } from '@l.x/lx/src/components/text/LearnMoreLink'
import { MAX_CUSTOM_SLIPPAGE_TOLERANCE, SLIPPAGE_CRITICAL_TOLERANCE } from '@l.x/lx/src/constants/transactions'
...
import type { TradeWithSlippage } from '@l.x/lx/src/features/transactions/swap/types/trade'
...
export function SlippageScreenNative(): JSX.Element {
  ...
  return (
    <Flex centered gap="$spacing16">
      ...
      {!isBridgeTrade && <LearnMoreLink url={lxUrls.helpArticleUrls.swapSlippage} />}
      <Flex gap="$spacing12">
