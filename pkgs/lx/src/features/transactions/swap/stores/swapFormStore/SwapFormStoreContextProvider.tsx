...
import { useEthAsErc20LxSwapQualifyingEvent } from 'lx/src/features/transactions/swap/hooks/useEthAsErc20LxSwapQualifyingEvent'
import {
  createSwapFormStore,
...
function SwapFormStoreContextProviderBase({
  ...
  useEthAsErc20LxSwapQualifyingEvent(derivedSwapInfo)
