...
import { useSwapAnalytics } from '@l.x/lx/src/features/transactions/swap/analytics'
import { useEthAsErc20LXQualifyingEvent } from '@l.x/lx/src/features/transactions/swap/hooks/useEthAsErc20LXQualifyingEvent'
import {
  createSwapFormStore,
  INITIAL_SWAP_FORM_STATE,
} from '@l.x/lx/src/features/transactions/swap/stores/swapFormStore/createSwapFormStore'
import { useDebouncedSwapFormAmounts } from '@l.x/lx/src/features/transactions/swap/stores/swapFormStore/hooks/useDebouncedSwapFormAmounts'
...
import { useDerivedSwapInfo } from '@l.x/lx/src/features/transactions/swap/stores/swapFormStore/hooks/useDerivedSwapInfo'
...
import { useOpenOutputSelectorOnPrefilledStateChange } from '@l.x/lx/src/features/transactions/swap/stores/swapFormStore/hooks/useOpenOutputSelectorOnPrefilledStateChange'
import { useUpdateSwapFormFromPrefilledCurrencies } from '@l.x/lx/src/features/transactions/swap/stores/swapFormStore/hooks/useUpdateSwapFormFromPrefilledCurrencies'
...
} from '@l.x/lx/src/features/transactions/swap/stores/swapFormStore/types'
...
function SwapFormStoreContextProviderBase({
  ...
  useEthAsErc20LXQualifyingEvent(derivedSwapInfo)
