...
import { isMaxPercentage } from '@luxexchange/lx/src/components/CurrencyInputPanel/AmountInputPresets/utils'
...
import { useOnToggleIsFiatMode } from '@luxexchange/lx/src/features/transactions/swap/stores/swapFormStore/hooks/useOnToggleIsFiatMode'
