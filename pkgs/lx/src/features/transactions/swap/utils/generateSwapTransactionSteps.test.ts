...
import { USDC, WBTC } from '@l.x/lx/src/constants/tokens'
...
import { ClassicTrade } from '@l.x/lx/src/features/transactions/swap/types/trade'
...
import {
  ...
  createMockLXTrade,
} from '@l.x/lx/src/test/fixtures/transactions/swap'
