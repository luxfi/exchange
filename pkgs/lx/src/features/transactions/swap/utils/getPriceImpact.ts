...
import { isClassic, isJupiter, isLX } from '@l.x/lx/src/features/transactions/swap/utils/routing'
...
function getLXPriceImpact({ derivedSwapInfo }: { derivedSwapInfo: DerivedSwapInfo }): Percent | undefined {
