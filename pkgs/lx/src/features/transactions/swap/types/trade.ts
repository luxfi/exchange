...
import { MixedRouteSDK, Trade as RouterSDKTrade, ZERO_PERCENT } from '@luxamm/router-sdk'
...
import { MAX_AUTO_SLIPPAGE_TOLERANCE } from '@l.x/lx/src/constants/transactions'
...
import { getTradingApiSwapFee } from '@l.x/lx/src/features/transactions/swap/types/getTradingApiSwapFee'
...
import { FrontendSupportedProtocol } from '@l.x/lx/src/features/transactions/swap/utils/protocols'
