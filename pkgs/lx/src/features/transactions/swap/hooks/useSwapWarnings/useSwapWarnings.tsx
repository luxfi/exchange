...
import type { ParsedWarnings, Warning } from '@luxexchange/lx/src/components/modals/WarningModal/types'
...
import { useTransactionGasWarning } from '@luxexchange/lx/src/features/gas/hooks'
...
} from '@luxexchange/lx/src/features/transactions/hooks/useParsedTransactionWarnings'
import { getBalanceWarning } from '@luxexchange/lx/src/features/transactions/swap/hooks/useSwapWarnings/getBalanceWarning'
import { getFormIncompleteWarning } from '@luxexchange/lx/src/features/transactions/swap/hooks/useSwapWarnings/getFormIncompleteWarning'
import { getPriceImpactWarning } from '@luxexchange/lx/src/features/transactions/swap/hooks/useSwapWarnings/getPriceImpactWarning'
import { getSwapWarningFromError } from '@luxexchange/lx/src/features/transactions/swap/hooks/useSwapWarnings/getSwapWarningFromError'
import { getTokenBlockedWarning } from '@luxexchange/lx/src/features/transactions/swap/hooks/useSwapWarnings/getTokenBlockedWarning'
import { useParsedActivePlanWarnings } from '@luxexchange/lx/src/features/transactions/swap/hooks/useSwapWarnings/useParsedActivePlanWarnings'
