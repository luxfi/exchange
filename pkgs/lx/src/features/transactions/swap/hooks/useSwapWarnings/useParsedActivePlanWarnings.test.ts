import { CurrencyAmount, NativeCurrency } from '@luxamm/sdk-core'
...
import { useOnChainCurrencyBalance, useOnChainNativeCurrencyBalance } from '@l.x/lx/src/features/portfolio/api'
