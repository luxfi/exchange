...
import { getFeeColor, useModalHeaderText, useModalSubtitleText } from '@l.x/lx/src/features/tokens/warnings/safetyUtils'
import TokenWarningModal from '@l.x/lx/src/features/tokens/warnings/TokenWarningModal'
import { WarningModalInfoContainer } from '@l.x/lx/src/features/tokens/warnings/WarningInfoModalContainer'
import { FoTFeeType, TokenFeeInfo } from '@l.x/lx/src/features/transactions/TransactionDetails/types'
