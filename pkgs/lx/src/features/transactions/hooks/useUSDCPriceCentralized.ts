...
import { getPrimaryStablecoin, isUniverseChainId } from '@l.x/lx/src/features/chains/utils'
import { isPriceServiceSupportedChain } from '@l.x/lx/src/features/prices/isPriceServiceSupportedChain'
import { useUSDCPrice as useUSDCPriceLegacy } from '@l.x/lx/src/features/transactions/hooks/useUSDCPrice'
