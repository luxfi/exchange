...
import { type SharedEventName } from '@luxamm/analytics-events'
import { type ProtocolVersion } from '@luxamm/client-data-api/dist/data/v1/poolTypes_pb'
import {
...
type BaseSwapTransactionResultProperties = {
  ...
  /** For Lux data sources, this should be of type Protocol from @luxamm/router-sdk. For other sources like Jupiter, this could be unknown values from their orderResponse.router field.*/
  protocol?: string
