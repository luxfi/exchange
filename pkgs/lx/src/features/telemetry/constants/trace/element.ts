...
export enum ElementName {
  ...
  ChainHanzoTestnet = 'chain-hanzo-testnet',
  ChainLiquidity = 'chain-liquidity',
  ChainLiquidityDev = 'chain-liquidity-dev',
  ...
  ChainZoo = 'chain-zoo',
  ChainZooDev = 'chain-zoo-dev',
  ChainZooTestnet = 'chain-zoo-testnet',
  ...
  NavbarCompanyMenuDEX = 'navbar-company-menu-dex',
  ...
  SwapRoutingPreferenceDEX = 'swap-routing-preference-DEX',
  ...
  SwapRoutingMethodAuto = 'swap-routing-method-auto',
  SwapRoutingMethodAMM = 'swap-routing-method-amm',
  SwapRoutingMethodDEXPrecompile = 'swap-routing-method-dex-precompile',
  ...
  LuxWalletBannerDownloadButton = 'lux-wallet-banner-download-button',
  LuxWalletConnector = 'lux-wallet-connector',
  LuxWalletLandingPageDownloadButton = 'lux-wallet-landing-page-download-button',
  LuxWalletModalDownloadButton = 'lux-wallet-modal-download-button',
  LuxWalletNavbarMenuDownloadButton = 'lux-wallet-navbar-menu-download-button',
  LuxWrappedBanner = 'lux-wrapped-banner',
  LuxWrappedNavbarButton = 'lux-wrapped-navbar-button',
  Unwrap = 'unwrap',
