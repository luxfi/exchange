export enum InterfaceEventName {
  ...
  LXOrderCancelInitiated = 'LX Order Cancel Initiated',
  LXOrderDetailsSheetOpened = 'LX Order Details Sheet Opened',
  LXOrderPostError = 'LX Order Post Error',
  LXOrderSubmitted = 'LX Order Submitted',
