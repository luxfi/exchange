...
import { AnimatePresence, Button, Flex, FlexProps, Input, InputProps, Text, TextProps, TouchableArea } from '@l.x/ui/src'
...
import { fonts, imageSizes, spacing } from '@l.x/ui/src/theme'
...
import { getUnitagFormatError, useCanClaimUnitagName } from '@l.x/lx/src/features/unitags/hooks/useCanClaimUnitagName'
import { UnitagInfoModal } from '@l.x/lx/src/features/unitags/UnitagInfoModal'
import { UnitagName } from '@l.x/lx/src/features/unitags/UnitagName'
import { getYourNameString } from '@l.x/lx/src/features/unitags/utils'
...
import { isChrome, isMobileApp, isWebPlatform } from '@l.x/utils/src/platform'
