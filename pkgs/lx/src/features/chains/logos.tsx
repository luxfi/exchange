...
import { ArbiscanLogoDark } from '@l.x/ui/src/components/logos/ArbiscanLogoDark'
import { ArbiscanLogoLight } from '@l.x/ui/src/components/logos/ArbiscanLogoLight'
import { EtherscanLogoDark } from '@l.x/ui/src/components/logos/EtherscanLogoDark'
import { EtherscanLogoLight } from '@l.x/ui/src/components/logos/EtherscanLogoLight'
import { OpEtherscanLogoDark } from '@l.x/ui/src/components/logos/OpEtherscanLogoDark'
import { OpEtherscanLogoLight } from '@l.x/ui/src/components/logos/OpEtherscanLogoLight'
import { PolygonscanLogoDark } from '@l.x/ui/src/components/logos/PolygonscanLogoDark'
import { PolygonscanLogoLight } from '@l.x/ui/src/components/logos/PolygonscanLogoLight'
import { SolscanLogoDark } from '@l.x/ui/src/components/logos/SolscanLogoDark'
import { SolscanLogoLight } from '@l.x/ui/src/components/logos/SolscanLogoLight'
...
const BLOCK_EXPLORER_LOGOS_LIGHT: Record<UniverseChainId, GeneratedIcon> = {
  ...
  [UniverseChainId.Hanzo]: BlockExplorer,
  [UniverseChainId.Liquidity]: BlockExplorer,
  [UniverseChainId.LiquidityTestnet]: BlockExplorer,
  [UniverseChainId.Lux]: BlockExplorer,
  [UniverseChainId.LuxTestnet]: BlockExplorer,
  [UniverseChainId.LuxDev]: BlockExplorer,
  [UniverseChainId.Pars]: BlockExplorer,
  [UniverseChainId.SPC]: BlockExplorer,
  ...
  [UniverseChainId.Zoo]: BlockExplorer,
  [UniverseChainId.ZooTestnet]: BlockExplorer,
