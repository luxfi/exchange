...
import { PARS_CHAIN_INFO } from '@l.x/lx/src/features/chains/evm/info/pars'
...
import { SPC_CHAIN_INFO } from '@l.x/lx/src/features/chains/evm/info/spc'
...
export const UNIVERSE_CHAIN_INFO = {
  ...
  [UniverseChainId.Liquidity]: LIQUIDITY_CHAIN_INFO,
