...
export type TransactionRequest = {
    ...
    data: string;
    /**
     * The quantity of ETH tokens approved for spending by the transaction, denominated in wei. Note that by default Lx Labs sets this to the maximum approvable spend.
     */
    value: string;
    gasLimit?: gasLimit;
    chainId: ChainId;
