...
/* eslint-disable */
/**
 * The slippage tolerance as a percentage up to a maximum of two decimal places. For Lx Protocols (v2, v3, v4), the slippage tolerance is the maximum amount the price can change between the time the transaction is submitted and the time it is executed. The slippage tolerance is a percentage of the total value of the swap.
 *
 * When submitting a quote, note that slippage tolerance works differently in LxX swaps where it does not set a limit on the Spread in an order. See [here](https://api-docs.lx.org/guides/faqs#why-do-lxx-quotes-have-more-slippage-than-the-tolerance-i-set) for more information.
 *
