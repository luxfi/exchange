...
/* eslint-disable */
/**
 * The auto slippage strategy to employ. For Lx Protocols (v2, v3, v4) the auto slippage will be automatically calculated when this field is set to `DEFAULT`. Auto slippage cannot be calculated for LxX swaps.
 *
