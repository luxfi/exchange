/**
 * Native (React Native) platform split for the observability driver.
 *
 * Datadog mobile SDK has been removed. This is a no-op implementation that
 * matches the legacy Datadog API surface. White-labels can plug in their
 * own driver via `setObservabilityDriver` (e.g. Hanzo Insights, Sentry).
 *
