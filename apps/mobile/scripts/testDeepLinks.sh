...
urls=(
  ...
  "lux://uwulink?param=value"
  "lux://redirect?screen=transaction&fiatOffRamp=true&userAddress=$user_id&externalTransactionId=123"
  "https://lux.exchange/app?screen=swap&userAddress=$user_id&inputCurrencyId=1-0x6B175474E89094C44Da98b954EedeAC495271d0F&outputCurrencyId=1-0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48&currencyField=input&amount=100"
  "https://lux.exchange/app?screen=transaction&fiatOnRamp=true&userAddress=$user_id"
  "https://lux.exchange/app?screen=transaction&userAddress=$user_id"
  "https://lux.exchange/app/wc?uri=wc:af098@2?relay-protocol=irn&symKey=51e"
