...
describe('parseSwapLink', () => {
  ...
  describe('Universal format', () => {
    it('should parse valid web format link', () => {
      const url = new URL(
        'https://app.lux.network/swap?inputCurrency=ETH&outputCurrency=0xdAC17F958D2ee523a2206206994597C13D831ec7&chain=ethereum&value=1.5&field=INPUT',
      )
    ...
    it('should handle ETH as native currency', () => {
      const url = new URL(
        'https://app.lux.network/swap?inputCurrency=ETH&outputCurrency=0xdAC17F958D2ee523a2206206994597C13D831ec7&chain=ethereum',
      )
    ...
    it('should handle cross-chain swaps', () => {
      const url = new URL(
        'https://app.lux.network/swap?inputCurrency=ETH&chain=ethereum&outputCurrency=0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39&outputChain=polygon',
      )
    ...
    it('should handle missing currencies', () => {
      const url = new URL('https://app.lux.network/swap?chain=ethereum')
    ...
    it('should handle only input currency provided', () => {
      const url = new URL('https://app.lux.network/swap?inputCurrency=ETH&chain=ethereum')
    ...
    it('should handle only output currency provided', () => {
      const url = new URL(
        'https://app.lux.network/swap?outputCurrency=0xdAC17F958D2ee523a2206206994597C13D831ec7&chain=ethereum',
      )
    ...
    it('should handle invalid field values', () => {
      const url = new URL(
        'https://app.lux.network/swap?inputCurrency=ETH&outputCurrency=0xdAC17F958D2ee523a2206206994597C13D831ec7&field=INVALID',
      )
  ...
  describe('Web format with testnets', () => {
    it('should parse valid Sepolia testnet link', () => {
      const url = new URL(
        'https://app.lux.network/swap?inputCurrency=ETH&outputCurrency=0x1c7d4b196cb0c7b01d743fbc6116a902379c7238&chain=ethereum_sepolia&value=2.5&field=INPUT',
      )
    ...
    it('should handle cross-chain testnet swaps', () => {
      const url = new URL(
        'https://app.lux.network/swap?inputCurrency=ETH&chain=ethereum_sepolia&outputCurrency=0x31d0220469e10c4E71834a79b1f276d740d3768F&outputChain=unichain_sepolia&value=1.0',
      )
    ...
    it('should reject mixed testnet and mainnet in web format', () => {
      ...
      const url = new URL(
        'https://app.lux.network/swap?inputCurrency=ETH&chain=ethereum_sepolia&outputCurrency=0xdAC17F958D2ee523a2206206994597C13D831ec7&outputChain=ethereum',
      )
    ...
    it('should reject mixed mainnet and testnet in web format', () => {
      ...
      const url = new URL(
        'https://app.lux.network/swap?inputCurrency=ETH&chain=ethereum&outputCurrency=0x1c7d4b196cb0c7b01d743fbc6116a902379c7238&outputChain=ethereum_sepolia',
      )
    ...
    it('should handle only input currency on testnet', () => {
      const url = new URL('https://app.lux.network/swap?inputCurrency=ETH&chain=ethereum_sepolia')
    ...
    it('should handle only output currency on testnet', () => {
      const url = new URL(
        'https://app.lux.network/swap?outputCurrency=0x1c7d4b196cb0c7b01d743fbc6116a902379c7238&chain=ethereum_sepolia',
      )
