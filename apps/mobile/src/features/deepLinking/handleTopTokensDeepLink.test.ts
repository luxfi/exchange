...
describe('handleTopTokensDeepLink', () => {
  const unichainExploreUrl = 'https://app.lux.network/explore/tokens/unichain'
  ...
  it('should handle valid metric parameter in URL', () => {
    const urlWithMetric = 'https://app.lux.network/explore/tokens/unichain?metric=volume'
  ...
  it('should navigate to explore modal without chainId', () => {
    const urlWithoutChainId = 'https://app.lux.network/explore/tokens'
  ...
  it('should handle metric parameter in URL without chainId', () => {
    const urlWithMetricNoChainId = 'https://app.lux.network/explore/tokens?metric=market_cap'
  ...
  describe('metric validation', () => {
    it('should handle invalid metric values and set orderByMetric to undefined', () => {
      const urlWithInvalidMetric = 'https://app.lux.network/explore/tokens/unichain?metric=invalid_metric'
    ...
    it('should handle empty metric parameter and set orderByMetric to undefined', () => {
      const urlWithEmptyMetric = 'https://app.lux.network/explore/tokens/unichain?metric='
    ...
    it('should handle case-insensitive valid metrics', () => {
      const testCases = [
        {
          url: 'https://app.lux.network/explore/tokens/unichain?metric=total_value_locked',
          expected: 'TOTAL_VALUE_LOCKED',
        },
        { url: 'https://app.lux.network/explore/tokens/unichain?metric=market_cap', expected: 'MARKET_CAP' },
        {
          url: 'https://app.lux.network/explore/tokens/unichain?metric=price_percent_change_1_day_asc',
          expected: 'PRICE_PERCENT_CHANGE_1_DAY_ASC',
        },
        {
          url: 'https://app.lux.network/explore/tokens/unichain?metric=price_percent_change_1_day_desc',
    ...
    it('should reject TRENDING metric (excluded CustomRankingType)', () => {
      const urlWithTrendingMetric = 'https://app.lux.network/explore/tokens/unichain?metric=trending'
    ...
    it('should handle mixed case metrics correctly', () => {
      const urlWithMixedCaseMetric = 'https://app.lux.network/explore/tokens/unichain?metric=VoLuMe'
    ...
    it('should handle numeric metric values as invalid', () => {
      const urlWithNumericMetric = 'https://app.lux.network/explore/tokens/unichain?metric=123'
    ...
    it('should handle special characters in metric as invalid', () => {
      const urlWithSpecialCharsMetric = 'https://app.lux.network/explore/tokens/unichain?metric=volume@#$'
    ...
    it('should handle various invalid metric formats', () => {
      const testCases = [
        { url: 'https://app.lux.network/explore/tokens/unichain?metric=true', desc: 'boolean-like' },
        { url: 'https://app.lux.network/explore/tokens/unichain?metric=volume,market_cap', desc: 'array-like' },
        {
          url: "https://app.lux.network/explore/tokens/unichain?metric=volume'; DROP TABLE--",
          desc: 'SQL injection-like',
        },
        { url: `https://app.lux.network/explore/tokens/unichain?metric=${'a'.repeat(100)}`, desc: 'very long' },
      ]
    ...
    it('should handle URL encoded metric values correctly', () => {
      const urlWithEncodedMetric = 'https://app.lux.network/explore/tokens/unichain?metric=MARKET%5FCAP'
  ...
  describe('getValidRankingType function edge cases', () => {
    it('should return undefined for falsy metrics (null, empty, whitespace)', () => {
      const testCases = [
        'https://app.lux.network/explore/tokens/unichain?other=value', // null metric
        'https://app.lux.network/explore/tokens/unichain?metric=', // empty
        'https://app.lux.network/explore/tokens/unichain?metric=%20%20%20', // whitespace
      ]
    ...
    it('should convert valid lowercase metric to uppercase', () => {
      const urlWithLowercaseMetric = 'https://app.lux.network/explore/tokens/unichain?metric=volume'
    ...
    it('should handle mixed case metric conversion', () => {
      const urlWithMixedCaseMetric = 'https://app.lux.network/explore/tokens/unichain?metric=mArKeT_cAp'
      return expectSaga(handleTopTokensDeepLink, { chainId: unichainChainId, url: urlWithMixedCaseMetric })
        .call(dismissAllModalsBeforeNavigation)
        .call(navigate, ModalName.Explore, {
          screen: MobileScreens.Explore,
    ...
    it('should return undefined for unsupported metric values', () => {
      const urlWithUnsupportedMetric = 'https://app.lux.network/explore/tokens/unichain?metric=unsupported_metric'
    ...
    it('should reject TRENDING metric in any case format', () => {
      const testCases = [
        'https://app.lux.network/explore/tokens/unichain?metric=trending',
        'https://app.lux.network/explore/tokens/unichain?metric=TrEnDiNg',
      ]
    ...
    it('should handle valid RankingType values - all uppercase variants', () => {
      ...
      return Promise.all(
        validMetrics.map((metric) => {
          const urlWithMetric = `https://app.lux.network/explore/tokens/unichain?metric=${metric}`
          return expectSaga(handleTopTokensDeepLink, { chainId: unichainChainId, url: urlWithMetric })
            .call(dismissAllModalsBeforeNavigation)
            .call(navigate, ModalName.Explore, {
              screen: MobileScreens.Explore,
  ...
  describe('URL edge cases', () => {
    it('should handle URL without search params', () => {
      const basicUrl = 'https://app.lux.network/explore/tokens/unichain'
    ...
    it('should handle URL with multiple query parameters', () => {
      const urlWithMultipleParams = 'https://app.lux.network/explore/tokens/unichain?metric=volume&other=value&foo=bar'
    ...
    it('should handle URL with fragment identifier', () => {
      const urlWithFragment = 'https://app.lux.network/explore/tokens/unichain?metric=market_cap#section'
