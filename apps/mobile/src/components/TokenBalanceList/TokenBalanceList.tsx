...
import { EmptyTokensList } from '@l.x/lx/src/components/portfolio/EmptyTokensList'
import { HiddenTokensRow } from '@l.x/lx/src/components/portfolio/HiddenTokensRow'
import { TokenBalanceItem } from '@l.x/lx/src/components/portfolio/TokenBalanceItem'
import { TokenBalanceItemContextMenu } from '@l.x/lx/src/components/portfolio/TokenBalanceItemContextMenu'
...
} from '@l.x/lx/src/features/portfolio/TokenBalanceListContext'
import { isHiddenTokenBalancesRow, TokenBalanceListRow } from '@l.x/lx/src/features/portfolio/types'
...
<<<<<<< HEAD
      {tokenBalanceItem}
=======
      <TokenBalanceItem padded isHidden={isHidden} isLoading={isWarmLoading} currencyInfo={currencyInfo} />
>>>>>>> upstream/main
    </TokenBalanceItemContextMenu>
  )
})
