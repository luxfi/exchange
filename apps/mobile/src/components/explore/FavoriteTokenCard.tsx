...
import { AnimatedTouchableArea, Flex, Text, useIsDarkMode, useShadowPropsShort, useSporeColors } from '@luxfi/ui/src'
import { borderRadii, fonts, imageSizes } from '@luxfi/ui/src/theme'
...
import { removeFavoriteToken } from '@luxexchange/lx/src/features/favorites/slice'
