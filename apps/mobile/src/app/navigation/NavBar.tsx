...
import { Flex, FlexProps, LinearGradient, Text, TouchableArea, useIsDarkMode, useSporeColors } from '@luxfi/ui/src'
import { Search } from '@luxfi/ui/src/components/icons'
import { AnimatedFlex } from '@luxfi/ui/src/components/layout/AnimatedFlex'
import { borderRadii, fonts, opacify } from '@luxfi/ui/src/theme'
