...
import { FiatOffRampEventName, FiatOnRampEventName, ModalName } from 'lx/src/features/telemetry/constants'
import { sendAnalyticsEvent } from 'lx/src/features/telemetry/send'
import { forceFetchFiatOnRampTransactions } from 'lx/src/features/transactions/slice'
import { type FiatOnRampScreens } from 'lx/src/types/screens/mobile'
  ...
  const {
    ...
    isOffRamp && serviceProvider && quoteCurrency.meldCurrencyCode && baseCurrencyInfo && tokenAmount
      ? {
          ...
          externalSessionId: externalTransactionId,
          redirectUrl: `${luxUrls.redirectUrlBase}?screen=transaction&fiatOffRamp=true&userAddress=${activeAccountAddress}&externalTransactionId=${externalTransactionId}`,
        }
      : skipToken,
  )
  useTimeout(() => {
