...
fun CopyButtonIcon(
  ...
  Box(
    ...
    Icon(
      painter = painterResource(id = R.drawable.lux_icon_copy_outline),
      contentDescription = null,
      tint = if (isCopied) LuxTheme.colors.statusSuccess else LuxTheme.colors.neutral1,
...
fun CopyButton(
  ...
  ActionButton(
    ...
    iconDrawable = R.drawable.lux_icon_copy,
