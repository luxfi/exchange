...
import com.lux.EthersRs.generateMnemonic
import com.lux.EthersRs.privateKeyFromMnemonic
import com.lux.EthersRs.signHashWithWallet
import com.lux.EthersRs.signMessageWithWallet
import com.lux.EthersRs.signTxWithWallet
import com.lux.EthersRs.walletFromPrivateKey
...
class RnEthersRs(applicationContext: Context) {
  ...
  companion object {
    private const val PREFIX = "com.lux"
