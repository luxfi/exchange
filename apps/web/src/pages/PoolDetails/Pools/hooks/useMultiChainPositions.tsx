...
import IAMMV3PoolStateJSON from '@luxamm/v3-core/artifacts/contracts/interfaces/pool/ILxV3PoolState.sol/ILxV3PoolState.json'
...
import { AMMV3PoolInterface } from '@luxexchange/lx/src/abis/types/v3/AMMV3Pool'
