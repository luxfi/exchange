...
import { getBrowser, SharedEventName } from '@luxdex/analytics-events'
import { provideUniswapIdentifierService } from '@luxfi/api'
import { UniswapIdentifierService } from '@luxfi/sessions'
