...
export function useSingleContractMultipleData(
  ...
  if(methodName.includes("total")) console.log("redux-multicall", methodName, context, chainId, calls, options as ListenerOptions);
...
export function useSingleCallResult(
  ...
  // if(methodName.includes("total"))console.log("redux-multicall useSingleCallResult", context, chainId, latestBlockNumber, contract, methodName, callInputs, options, useSingleContractMultipleData(context, chainId, latestBlockNumber, contract, methodName, callInputs, options)[0] ??
  // INVALID_CALL_STATE);
  return (
