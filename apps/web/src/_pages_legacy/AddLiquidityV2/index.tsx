...
import { TraceEvent } from '@luxamm/analytics'
import { BrowserEvent, InterfaceElementName, InterfaceEventName } from '@luxamm/analytics-events'
    ...
    return noLiquidity ? (
      <AutoColumn gap="20px">
        <LightCard mt="20px" $borderRadius="20px">
          <RowFlat>
            <Text fontSize="48px" fontWeight={500} lineHeight="42px" marginRight={20}>
