...
import { formatNumber, formatUSDPrice, NumberType } from '@luxamm/conedison/format'
import { useAtomValue } from 'jotai/utils'
import QueryTokenLogo from 'components/Logo/QueryTokenLogo'
import CurrencyLogo from 'components/Logo/CurrencyLogo'
import { sendAnalyticsEvent } from '@luxamm/analytics'
import { InterfaceEventName } from '@luxamm/analytics-events'
...
const StyledTransactionRow = styled.div<{
  ...
  grid-template-columns: 3fr 1fr 6fr 8fr 8fr 7fr;
  ...
  @media only screen and (max-width: ${LARGE_MEDIA_BREAKPOINT}) {
    grid-template-columns: 3fr 1fr 6fr 8fr 8fr;
  }

  @media only screen and (max-width: ${MEDIUM_MEDIA_BREAKPOINT}) {
    grid-template-columns: 3fr 1fr 6fr 8fr;
