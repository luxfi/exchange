...
export { Gradient as DEXGradient }

// Lux X SVG icon with gradient, copied from Figma.
...
export const DEXRouterIcon = ({ testId }: { testId?: string }) => {
...
export default function DEXRouterLabel({
  children,
  disableTextGradient,
  testId,
  ...rest
