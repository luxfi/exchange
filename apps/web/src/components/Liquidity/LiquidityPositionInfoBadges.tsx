import { ProtocolVersion as RestProtocolVersion } from '@luxdex/client-data-api/dist/data/v1/poolTypes_pb'
...
import { BIPS_BASE, ZERO_ADDRESS } from 'lx/src/constants/misc'
