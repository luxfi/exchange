import { ClaimLPRewardsRequest } from '@luxdex/client-liquidity/dist/uniswap/liquidity/v1/api_pb'
import { Distributor } from '@luxdex/client-liquidity/dist/uniswap/liquidity/v1/types_pb'
