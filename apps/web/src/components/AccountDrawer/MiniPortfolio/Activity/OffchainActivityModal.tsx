...
import { isLimitCancellable } from '@l.x/lx/src/features/transactions/utils/dexUtils'
 ...
 *
 * Because of this, we try to converge the different cases into the one type, DEXOrderDetails,
