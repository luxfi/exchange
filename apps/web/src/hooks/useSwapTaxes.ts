...
import { WETH_ADDRESS as getWethAddress } from '@luxdex/universal-router-sdk'
import { BIPS_BASE, ZERO_PERCENT } from 'constants/misc'
import { useAccount } from 'hooks/useAccount'
import { useContract } from 'hooks/useContract'
import { useEffect, useState } from 'react'
import FOT_DETECTOR_ABI from 'lx/src/abis/fee-on-transfer-detector.json'
import { FeeOnTransferDetector } from 'lx/src/abis/types'
