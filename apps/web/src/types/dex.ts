...
interface NonfilledDEXBackendOrder extends BaseDEXBackendOrder {
  orderStatus:
...
interface FilledDEXBackendOrder extends BaseDEXBackendOrder {
...
export type DEXBackendOrder = FilledDEXBackendOrder | NonfilledDEXBackendOrder

export type OrderQueryResponse = {
  orders: DEXBackendOrder[]
}
