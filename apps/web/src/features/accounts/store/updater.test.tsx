import type { ConnectionStatusInfo } from '@luxexchange/lx/src/features/accounts/store/types/Connector'
...
import { setUserProperty } from '@luxexchange/lx/src/features/telemetry/user'
