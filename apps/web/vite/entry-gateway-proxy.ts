...
const DEV_ENTRY_GATEWAY_API_BASE_URL = 'https://entry-gateway.backend-dev.api.lux.network'
const STAGING_ENTRY_GATEWAY_API_BASE_URL = 'https://entry-gateway.backend-staging.api.lux.network'
const PROD_ENTRY_GATEWAY_API_BASE_URL = 'https://entry-gateway.backend-prod.api.lux.network'

/**
 * Returns the appropriate Entry Gateway API URL for the proxy target.
 * Duplicated from @l.x/api to avoid importing app code into build config.
 */
