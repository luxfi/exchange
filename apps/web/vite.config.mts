...
export default defineConfig(({ mode }) => {
  ...
  const overrides = {
    ...
    '@l.x/api': path.resolve(__dirname, '../../pkgs/api'),
    '@l.x/config/src': path.resolve(__dirname, '../../pkgs/config/src'),
    '@l.x/config': path.resolve(__dirname, '../../pkgs/config'),
    '@l.x/gating/src': path.resolve(__dirname, '../../pkgs/gating/src'),
    '@l.x/gating': path.resolve(__dirname, '../../pkgs/gating'),
    '@l.x/notifications/src': path.resolve(__dirname, '../../pkgs/notifications/src'),
    '@l.x/notifications': path.resolve(__dirname, '../../pkgs/notifications'),
    '@l.x/prices/src': path.resolve(__dirname, '../../pkgs/prices/src'),
    '@l.x/prices': path.resolve(__dirname, '../../pkgs/prices'),
