...
export default defineConfig(({ mode }) => {
  ...
  const overrides = {
    ...
    '@luxexchange/sessions/src': path.resolve(__dirname, '../../pkgs/sessions/src'),
    '@luxexchange/sessions': path.resolve(__dirname, '../../pkgs/sessions'),
    '@luxexchange/api/src': path.resolve(__dirname, '../../pkgs/api/src'),
    '@luxexchange/api': path.resolve(__dirname, '../../pkgs/api'),
    '@luxexchange/config/src': path.resolve(__dirname, '../../pkgs/config/src'),
    '@luxexchange/config': path.resolve(__dirname, '../../pkgs/config'),
    '@luxexchange/gating/src': path.resolve(__dirname, '../../pkgs/gating/src'),
    '@luxexchange/gating': path.resolve(__dirname, '../../pkgs/gating'),
    '@luxexchange/notifications/src': path.resolve(__dirname, '../../pkgs/notifications/src'),
    '@luxexchange/notifications': path.resolve(__dirname, '../../pkgs/notifications'),
    '@luxexchange/prices/src': path.resolve(__dirname, '../../pkgs/prices/src'),
    '@luxexchange/prices': path.resolve(__dirname, '../../pkgs/prices'),
    ...
    '@luxfi/api/src': path.resolve(__dirname, '../../pkgs/api/src'),
    '@luxfi/api': path.resolve(__dirname, '../../pkgs/api'),
    '@luxfi/config/src': path.resolve(__dirname, '../../pkgs/config/src'),
    ...
    '@luxfi/gating/src': path.resolve(__dirname, '../../pkgs/gating/src'),
    '@luxfi/gating': path.resolve(__dirname, '../../pkgs/gating'),
    '@luxfi/notifications/src': path.resolve(__dirname, '../../pkgs/notifications/src'),
    '@luxfi/notifications': path.resolve(__dirname, '../../pkgs/notifications'),
    '@luxfi/sessions/src': path.resolve(__dirname, '../../pkgs/sessions/src'),
