...
import { getLatestCheckpoint } from 'lx/src/data/rest/auctions/auctionService'
import { AUCTION_API_PATHS } from 'lx/src/data/rest/auctions/paths'
import type { GetLatestCheckpointRequest, GetLatestCheckpointResponse } from 'lx/src/data/rest/auctions/types'
