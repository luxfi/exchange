...
import { getAuctionDetails } from 'lx/src/data/rest/auctions/auctionService'
import { AUCTION_API_PATHS } from 'lx/src/data/rest/auctions/paths'
import type { GetAuctionDetailsRequest, GetAuctionDetailsResponse } from 'lx/src/data/rest/auctions/types'
