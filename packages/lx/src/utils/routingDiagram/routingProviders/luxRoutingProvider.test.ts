...
import { luxRoutingProvider } from 'lx/src/utils/routingDiagram/routingProviders/luxRoutingProvider'
...
describe('luxProvider', () => {
  describe('getPoolType', () => {
    it('identifies V2 pools correctly', () => {
      ...
      const result = luxRoutingProvider.getRoutingEntries(trade)
    ...
    it('throws error for unknown pool type', () => {
      ...
      expect(() => luxRoutingProvider.getRoutingEntries(trade as any)).toThrow('Unknown pool type')
    })
  })
  ...
  describe('path construction', () => {
    ...
    it('throws error for invalid route path', () => {
      ...
      expect(() => luxRoutingProvider.getRoutingEntries(trade as any)).toThrow('Invalid route path')
    })
  })
