...
const createMockDEXOrder = (inputToken: string, outputToken: string): TradingApi.DutchOrderInfoV2 => ({
  chainId: 1,
...
export const createMockDEXQuote = (inputToken: string, outputToken: string): TradingApi.DutchQuoteV2 => ({
  encodedOrder: '0x000',
  orderId: '0xbbb',
  orderInfo: createMockDEXOrder(inputToken, outputToken),
...
export const createMockDEXTrade = (inputCurrency: Token, outputCurrency: Token): DEXV2Trade => {
  return new DEXV2Trade({
    ...
    quote: {
      ...
      quote: createMockDEXQuote(inputCurrency.address, outputCurrency.address),
