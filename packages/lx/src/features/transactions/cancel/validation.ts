 ...
 */
export function hasValidCancellationData(order: DEXOrderDetails): order is DEXOrderDetails & {
  orderHash: string
  encodedOrder: string
} {
 ...
 */
export function validateOrdersForCancellation(orders: DEXOrderDetails[]): ValidationResult {
