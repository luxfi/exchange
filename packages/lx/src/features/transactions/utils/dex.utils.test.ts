...
describe('DEX Utils', () => {
  ...
  describe('isLimitOrder', () => {
    const mockLimitOrder: DEXOrderDetails = {
      id: 'test-limit-order',
    ...
    const mockRegularDEXOrder: DEXOrderDetails = {
      ...mockLimitOrder,
    ...
    it('should return false for regular DEX orders', () => {
      expect(isLimitOrder(mockRegularDEXOrder)).toBe(false)
    })
  })
})
