...
// Mock the @l.x/v2-sdk package to provide Pair.getAddress
jest.mock('@luxamm/v2-sdk', () => {
  const originalModule = jest.requireActual('@luxamm/v2-sdk')
...
const { Pair: V2Pool } = jest.requireActual('@luxamm/v2-sdk')
Object.setPrototypeOf(mockV2Pool, V2Pool.prototype)

jest.mock('@luxdex/v3-sdk', () => {
  const originalModule = jest.requireActual('@luxdex/v3-sdk')
...
const { Pool: V3Pool } = jest.requireActual('@luxdex/v3-sdk')
Object.setPrototypeOf(mockV3Pool, V3Pool.prototype)
//
const mockV4Pool = { poolId: '0xpool1', v4: true }
const { Pool: V4Pool } = jest.requireActual('@luxamm/v4-sdk')
