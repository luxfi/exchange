...
import { getSwapWarnings } from 'lx/src/features/transactions/swap/hooks/useSwapWarnings/useSwapWarnings'
...
import { daiCurrencyInfo, ethCurrencyInfo } from 'lx/src/test/fixtures'
