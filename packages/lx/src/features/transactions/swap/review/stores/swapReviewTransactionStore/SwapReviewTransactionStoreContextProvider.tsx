...
import type { SwapReviewTransactionState } from 'lx/src/features/transactions/swap/review/stores/swapReviewTransactionStore/createSwapReviewTransactionStore'
...
export const SwapReviewTransactionStoreContextProvider = ({
  ...
  const dexGasBreakdown = isDEX(swapTxContext) ? swapTxContext.gasFeeBreakdown : undefined
