...
import { transformPlanResponse } from 'lx/src/features/transactions/swap/plan/planSagaUtils'
...
function useActivePlanQuery(params: {
  ...
  return useQuery(
    ...
    queryWithoutCache({
      queryKey: [ReactQueryCacheKey.TradingApi, luxUrls.tradingApiPaths.plan, 'refresh', activePlanId],
      queryFn: () =>
        activePlanId
