import { SignMessageFunc, UnitagClaim, UnitagClaimContext } from '@luxfi/api'
...
import { uploadAndUpdateAvatarAfterClaim } from 'lx/src/features/unitags/avatars'
import { isLocalFileUri } from 'lx/src/features/unitags/fileUtils'
import { parseUnitagErrorCode } from 'lx/src/features/unitags/utils'
