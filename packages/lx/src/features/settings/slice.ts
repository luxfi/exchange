...
import { DEFAULT_DEVICE_ACCESS_TIMEOUT, DeviceAccessTimeout } from 'lx/src/features/settings/constants'
...
const slice = createSlice({
  ...
  reducers: {
    ...
    setShowVideoBackground: (state, { payload }: PayloadAction<boolean>) => {
      state.showVideoBackground = payload
    },
