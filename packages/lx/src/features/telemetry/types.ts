...
import { OnChainStatus } from '@luxdex/client-trading/dist/trading/v1/api_pb'
import { Currency, TradeType } from '@luxdex/sdk-core'
import { TradingApi, UnitagClaimContext } from '@luxfi/api'
...
import { RenderPassReport } from 'lx/src/types/RenderPassReport'
...
import { UwULinkMethod, WCEventType, WCRequestOutcome } from 'lx/src/types/walletConnect'
import { WidgetEvent, WidgetType } from 'lx/src/types/widgets'
...
type BaseSwapTransactionResultProperties = {
  ...
  /** For Uniswap data sources, this should be of type Protocol from @l.x/router-sdk. For other sources like Jupiter, this could be unknown values from their orderResponse.router field.*/
  protocol?: string
