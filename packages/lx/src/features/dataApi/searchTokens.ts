import { SearchTokensResponse, SearchType } from '@luxdex/client-search/dist/search/v1/api_pb'
import { GqlResult } from '@luxfi/api'
import { useMemo } from 'react'
import { searchTokenToCurrencyInfo, useSearchTokensAndPoolsQuery } from 'lx/src/data/rest/searchTokensAndPools'
