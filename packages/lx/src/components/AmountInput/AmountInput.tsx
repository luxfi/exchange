...
import { Input, type InputRef, Text } from 'ui/src'
import { numericInputEnforcer } from 'lx/src/components/AmountInput/utils/numericInputEnforcer'
...
export const AmountInput = forwardRef<InputRef, Props>(function _AmountInput(
  {
    onChangeText,
    value,
...
const TextInputWithNativeKeyboard = forwardRef<InputRef, TextInputProps>(function _TextInputWithNativeKeyboard(
