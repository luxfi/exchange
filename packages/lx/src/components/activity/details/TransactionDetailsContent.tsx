...
import { ApproveTransactionDetails } from 'lx/src/components/activity/details/transactions/ApproveTransactionDetails'
import { AuctionTransactionDetails } from 'lx/src/components/activity/details/transactions/AuctionTransactionDetails'
import { BridgeTransactionDetails } from 'lx/src/components/activity/details/transactions/BridgeTransactionDetails'
import { LiquidityTransactionDetails } from 'lx/src/components/activity/details/transactions/LiquidityTransactionDetails'
import { NftTransactionDetails } from 'lx/src/components/activity/details/transactions/NftTransactionDetails'
import { OffRampTransactionDetails } from 'lx/src/components/activity/details/transactions/OffRampTransactionDetails'
import { OnRampTransactionDetails } from 'lx/src/components/activity/details/transactions/OnRampTransactionDetails'
import { PlanTransactionDetails } from 'lx/src/components/activity/details/transactions/PlanTransactionDetails'
...
import { WrapTransactionDetails } from 'lx/src/components/activity/details/transactions/WrapTransactionDetails'
