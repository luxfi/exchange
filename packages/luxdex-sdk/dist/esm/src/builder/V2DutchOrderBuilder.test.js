...
describe("V2DutchOrderBuilder", () => {
    ...
    it("Regenerates builder from order json", () => {
        ...
        const regenerated = V2DutchOrderBuilder.fromOrder(CosignedV2DutchOrder.fromJSON(json, 1)).build();
    ...
    it("Regenerates builder allows modification", () => {
        ...
        const regenerated = V2DutchOrderBuilder.fromOrder(order)
            ...
            .build();
        expect(regenerated.info.cosignerData.decayStartTime).toEqual(order.info.cosignerData.decayStartTime + 1);
    });
    ...
    it("Unknown chainId", () => {
        ...
        expect(() => new V2DutchOrderBuilder(chainId)).toThrow(`Missing configuration for reactor: ${chainId}`);
    });
...
//# sourceMappingURL=V2DutchOrderBuilder.test.js.map