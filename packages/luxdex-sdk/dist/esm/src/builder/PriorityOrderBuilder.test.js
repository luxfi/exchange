...
describe("PriorityOrderBuilder", () => {
    ...
    it("Builds a valid order", () => {
        ...
        expect(order.info.outputs[0].mpsPerPriorityFeeWei).toEqual(BigNumber.from(1));
    });
    ...
    it("Regenerates builder from order json", () => {
        ...
        const regenerated = PriorityOrderBuilder.fromOrder(CosignedPriorityOrder.fromJSON(json, 1)).build();
        expect(regenerated.toJSON()).toMatchObject(order.toJSON());
    });
