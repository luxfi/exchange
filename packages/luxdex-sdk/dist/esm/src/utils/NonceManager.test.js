...
import { buildNonce, getCancelMultipleParams, getCancelSingleParams, getFirstUnsetBit, setBit, } from "./NonceManager";
describe("NonceManager", () => {
    ...
    describe("setBit", () => {
        ...
        it("16756735, 12", () => {
            expect(setBit(BigNumber.from(16756735), 12)).toEqual(BigNumber.from(16760831));
        });
    });
    ...
    describe("getCancelSingleParams", () => {
        it("0", () => {
            expect(getCancelSingleParams(BigNumber.from(0)).word.toString()).toEqual("0");
            expect(getCancelSingleParams(BigNumber.from(0)).mask.toString()).toEqual("1");
        });
        it("1", () => {
            expect(getCancelSingleParams(BigNumber.from(1)).word.toString()).toEqual("0");
            expect(getCancelSingleParams(BigNumber.from(1)).mask.toString()).toEqual("2");
        });
        it("2", () => {
            expect(getCancelSingleParams(BigNumber.from(2)).word.toString()).toEqual("0");
            expect(getCancelSingleParams(BigNumber.from(2)).mask.toString()).toEqual("4");
        });
        it("3", () => {
            expect(getCancelSingleParams(BigNumber.from(3)).word.toString()).toEqual("0");
            expect(getCancelSingleParams(BigNumber.from(3)).mask.toString()).toEqual("8");
        });
        it("255", () => {
            expect(getCancelSingleParams(BigNumber.from(256)).word.toString()).toEqual("1");
            expect(getCancelSingleParams(BigNumber.from(256)).mask.toString()).toEqual("1");
        });
        it("257", () => {
            expect(getCancelSingleParams(BigNumber.from(257)).word.toString()).toEqual("1");
            expect(getCancelSingleParams(BigNumber.from(257)).mask.toString()).toEqual("2");
        });
    });
    describe("getCancelMultipleParams", () => {
        it("0, 1", () => {
            expect(getCancelMultipleParams([BigNumber.from(0), BigNumber.from(1)]).length).toEqual(1);
            expect(getCancelMultipleParams([
                BigNumber.from(0),
                BigNumber.from(1),
        ...
        it("0, 256", () => {
            expect(getCancelMultipleParams([BigNumber.from(0), BigNumber.from(256)]).length).toEqual(2);
            expect(getCancelMultipleParams([
                BigNumber.from(0),
                BigNumber.from(256),
            ])[0].word.toString()).toEqual("0");
