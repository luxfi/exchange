...
import { CosignedPriorityOrder, OrderNotFillable,
...
describe("PriorityOrder", () => {
    ...
    it("valid signature over order", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("resolve", () => {
        it("throws when resolving if current block < auctionTargetBlock", () => {
            ...
            order = new CosignedPriorityOrder(getFullOrderInfo({
                cosignerData: {
