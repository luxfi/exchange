...
export class UnsignedV2DutchOrder {
    ...
    static fromJSON(json, chainId, _permit2Address) {
        return new UnsignedV2DutchOrder(Object.assign(Object.assign({}, json), { nonce: BigNumber.from(json.nonce), input: {
    ...
    cosignatureHash(cosignerData) {
        const abiCoder = new ethers.utils.AbiCoder();
        return ethers.utils.solidityKeccak256(["bytes32", "bytes"], [
            this.hash(),
...
export class CosignedV2DutchOrder extends UnsignedV2DutchOrder {
    ...
    static fromJSON(json, chainId, _permit2Address) {
        return new CosignedV2DutchOrder(Object.assign(Object.assign({}, json), { nonce: BigNumber.from(json.nonce), input: {
                token: json.input.token,
                startAmount: BigNumber.from(json.input.startAmount),
                endAmount: BigNumber.from(json.input.endAmount),
            }, outputs: json.outputs.map((output) => ({
