...
export class DutchOrder {
    ...
    static fromJSON(json, chainId, _permit2Address) {
        return new DutchOrder(Object.assign(Object.assign({}, json), { exclusivityOverrideBps: BigNumber.from(json.exclusivityOverrideBps), nonce: BigNumber.from(json.nonce), input: {
     ...
     */
    resolve(options) {
        const useOverride = this.info.exclusiveFiller !== ethers.constants.AddressZero &&
