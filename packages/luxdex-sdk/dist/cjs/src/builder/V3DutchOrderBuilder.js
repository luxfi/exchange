...
class V3DutchOrderBuilder extends OrderBuilder_1.OrderBuilder {
    ...
    initializeCosignerData(data) {
        this.info.cosignerData = Object.assign({ decayStartBlock: 0, exclusiveFiller: ethers_1.ethers.constants.AddressZero, exclusivityOverrideBps: ethers_1.BigNumber.from(0), inputOverride: ethers_1.BigNumber.from(0), outputOverrides: [] }, data);
    }
