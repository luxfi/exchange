...
class UnsignedPriorityOrder {
    ...
    static fromJSON(json, chainId, _permit2Address) {
        return new UnsignedPriorityOrder(Object.assign(Object.assign({}, json), { cosigner: json.cosigner, auctionStartBlock: ethers_1.BigNumber.from(json.auctionStartBlock), baselinePriorityFeeWei: ethers_1.BigNumber.from(json.baselinePriorityFeeWei), nonce: ethers_1.BigNumber.from(json.nonce), input: {
...
class CosignedPriorityOrder extends UnsignedPriorityOrder {
    ...
    static fromJSON(json, chainId, _permit2Address) {
        return new CosignedPriorityOrder(Object.assign(Object.assign({}, json), { nonce: ethers_1.BigNumber.from(json.nonce), cosigner: json.cosigner, auctionStartBlock: ethers_1.BigNumber.from(json.auctionStartBlock), baselinePriorityFeeWei: ethers_1.BigNumber.from(json.baselinePriorityFeeWei), input: {
                token: json.input.token,
                amount: ethers_1.BigNumber.from(json.input.amount),
                mpsPerPriorityFeeWei: ethers_1.BigNumber.from(json.input.mpsPerPriorityFeeWei),
            }, outputs: json.outputs.map((output) => ({
