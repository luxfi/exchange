...
exports.encodeRelativeBlocks = exports.CosignedV3DutchOrder = exports.UnsignedV3DutchOrder = exports.V3_DUTCH_ORDER_TYPES = void 0;
...
class UnsignedV3DutchOrder {
    ...
    static fromJSON(json, chainId, _permit2Address) {
        return new UnsignedV3DutchOrder(Object.assign(Object.assign({}, json), { nonce: ethers_1.BigNumber.from(json.nonce), startingBaseFee: ethers_1.BigNumber.from(json.startingBaseFee), input: Object.assign(Object.assign({}, json.input), { startAmount: ethers_1.BigNumber.from(json.input.startAmount), curve: {
                    relativeBlocks: json.input.curve.relativeBlocks,
                    relativeAmounts: json.input.curve.relativeAmounts.map((amount) => BigInt(amount)),
                }, maxAmount: ethers_1.BigNumber.from(json.input.maxAmount), adjustmentPerGweiBaseFee: ethers_1.BigNumber.from(json.input.adjustmentPerGweiBaseFee) }), outputs: json.outputs.map((output) => (Object.assign(Object.assign({}, output), { startAmount: ethers_1.BigNumber.from(output.startAmount), curve: {
                    relativeBlocks: output.curve.relativeBlocks,
                    relativeAmounts: output.curve.relativeAmounts.map((amount) => BigInt(amount)),
                }, minAmount: ethers_1.BigNumber.from(output.minAmount), adjustmentPerGweiBaseFee: ethers_1.BigNumber.from(output.adjustmentPerGweiBaseFee) }))) }), chainId, _permit2Address);
    }
    /**
     * @inheritdoc order
     */
...
class CosignedV3DutchOrder extends UnsignedV3DutchOrder {
    static fromUnsignedOrder(order, cosignerData, cosignature) {
        return new CosignedV3DutchOrder(Object.assign(Object.assign({}, order.info), { cosignerData,
            cosignature }), order.chainId, order.permit2Address);
    }
    static fromJSON(json, chainId, _permit2Address) {
        return new CosignedV3DutchOrder(Object.assign(Object.assign({}, json), { nonce: ethers_1.BigNumber.from(json.nonce), startingBaseFee: ethers_1.BigNumber.from(json.startingBaseFee), input: {
