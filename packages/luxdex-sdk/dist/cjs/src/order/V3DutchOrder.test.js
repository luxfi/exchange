...
describe("V3DutchOrder", () => {
    ...
    it("valid signature over inner order", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, chai_1.expect)(order.getSigner(signature)).equal(yield wallet.getAddress());
        ...
        (0, chai_1.expect)(fullOrder.getSigner(signature)).equal(yield wallet.getAddress());
    }));
    it("validates cosignature over (hash || cosignerData)", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const wallet = ethers_1.ethers.Wallet.createRandom();
        const orderInfo = getFullOrderInfo({
        ...
        (0, chai_1.expect)(signedOrder.recoverCosigner()).equal(yield wallet.getAddress());
    }));
