...
export interface ProxyInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "owner" | "setOwner" | "setTarget" | "target"): FunctionFragment;
...
export type ProxyOwnerChangedEventFilter = TypedEventFilter<ProxyOwnerChangedEvent>;
