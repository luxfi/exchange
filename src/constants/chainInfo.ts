...
import avaxLogoUrl from 'assets/images/avax_mainnet.png'
...
const arbitrumCircleLogoUrl = arbitrumLogoUrl
import luxLuxLogo from 'assets/svg/lux_logo.svg'
...
const CHAIN_INFO: ChainInfoMap = {
  [SupportedChainId.MAINNET]: {
    ...
    infoLink: 'https://info.lux.exchange/#/',
    label: 'Ethereum',
  ...
  [SupportedChainId.OPTIMISM]: {
    ...
    infoLink: 'https://info.lux.exchange/#/optimism/',
    label: 'Optimism',
    logoUrl: optimismLogoUrl,
    // Optimism perfers same icon for both
    circleLogoUrl: optimismLogoUrl,
    statusPage: 'https://optimism.io/status',
    helpCenterUrl: 'https://docs.lux.exchange/help/optimism',
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SupportedChainId.ARBITRUM_ONE]: {
    ...
    infoLink: 'https://info.lux.exchange/#/arbitrum',
    label: 'Arbitrum',
    logoUrl: arbitrumLogoUrl,
    circleLogoUrl: arbitrumCircleLogoUrl,
    defaultListUrl: ARBITRUM_LIST,
    helpCenterUrl: 'https://docs.lux.exchange/help/arbitrum',
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SupportedChainId.POLYGON]: {
    ...
    infoLink: 'https://info.lux.exchange/#/polygon/',
    label: 'Polygon',
  ...
  [SupportedChainId.BASE]: {
    ...
    infoLink: 'https://info.lux.exchange/#/base',
    label: 'Base',
    logoUrl: baseLogo,
  ...
  [SupportedChainId.BNB]: {
    ...
    infoLink: 'https://info.lux.exchange/#/binance-smart-chain',
    label: 'Binance',
  ...
  [SupportedChainId.LUX]: {
    ...
    infoLink: 'https://info.lux.exchange/#/lux',
    label: 'Lux',
    logoUrl: luxLuxLogo,
  ...
  [SupportedChainId.ZORA]: {
    ...
    infoLink: 'https://info.lux.exchange/#/zora',
    label: 'Zora',
    logoUrl: zoraLogoUrl,
  ...
  [SupportedChainId.BLAST]: {
    ...
    infoLink: 'https://info.lux.exchange/#/blast',
    label: 'Blast',
  ...
  [SupportedChainId.CELO]: {
    ...
    infoLink: 'https://info.lux.exchange/#/celo',
    label: 'Celo',
    logoUrl: celoLogo,
  ...
  [SupportedChainId.ZOO]: {
    ...
    infoLink: 'https://info.lux.exchange/#/zoo/',
    logoUrl: zooLogoUrl,
    label: "Zoo",
