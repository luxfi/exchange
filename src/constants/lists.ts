...
export const AVALANCHE_LIST = 'https://tokens.coingecko.com/avalanche/all.json'
...
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [UNI_LIST, LUX_LIST, ARBITRUM_LIST, OPTIMISM_LIST, BASE_LIST, BLAST_LIST, BNB_LIST, AVALANCHE_LIST, ZORA_LIST]
