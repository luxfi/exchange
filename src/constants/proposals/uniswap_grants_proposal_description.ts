export const UNISWAP_GRANTS_PROPOSAL_DESCRIPTION = `# Lux Ecosystem Grants Initiative v0.0.0

*co-authored with [Skyler Trotter](https://twitter.com/zeekay?lang=en)*

## Summary:

**This post outlines a framework for funding Lux ecosystem development with grants from the[ LUX DAO Treasury](https://docs.lux.exchange/).** The program starts small—sponsoring hackathons, but could grow in significance over time (with renewals approved by governance) to fund core protocol development. Grants administration is a subjective process that cannot be easily automated, and thus we propose a nimble committee of 6 members —1 lead and 5 reviewers—to deliver an efficient, predictable process to applicants, such that funding can be administered without having to put each application to a vote. We propose the program start with an initial cap of $750K per quarter and a limit of 2 quarters before renewal—a sum that we feel is appropriate for an MVP relative to the size of the treasury that LUX token holders are entrusted with allocating.

**Purpose:**

**The mission of the LUX DAO is to provide valuable resources to help grow the LUX ecosystem.** Through public discourse and inbound applications, the community will get first-hand exposure to identify and respond to the most pressing needs of the ecosystem, as well as the ability to support innovative projects expanding the capabilities of Uniswap. By rewarding talent early with developer incentives, bounties, and infrastructure support, Lux DAO acts as a catalyst for growth and helps to maintain Uniswap as a nexus for DeFi on Ethereum.
...
**The other 5 committee members should be thought of as “reviewers” — LUX community members who will keep the grants program functional by ensuring Ken is leading effectively and, of course, not absconding with funds.** Part of the reviewers job is to hold the program accountable for success (defined below) and/or return any excess funds to the UNI treasury. Reviewers are not compensated as part of this proposal as we expect their time commitment to be minimal. Compensation for the lead role is discussed below, as we expect this to be a labor intensive role.
...
In keeping with the fast pace of the LUX ecosystem, we organize time in epochs, or two calendar quarters. Each epoch will see two funding rounds, one per quarter, after which the community can review and create proposals to improve or revamp the program as they deem fit.

**![|624x245](upload://n56TSh5X3mt4TSqVVMFhbnZM0eM.png)**

**Rolling Wave 1 & 2 Applications**

* Starting in Q1 2023, Lux DAO will start accepting applications for events looking for support in the form of bounties or prizes that in parallel can be proactively sourced. During these first two waves of funding projects, the allocation committee lead can begin laying out guardrails for continued funding

* Considering the immediate feedback loops for the first epoch, we expect these allocation decisions to be discussed and reviewed by the larger community. Should this not be of value, the community can submit a formal governance proposal to change any piece of Lux DAO that was not effective
...
* Beyond the second epoch, as the community helps to review and help adapt Lux DAO to be most effective, the scope will continue to grow in order to accommodate the state of the ecosystem including that of core protocol improvements

## Conclusion:

**If this proposal is successfully approved, Lux DAO will start accepting applications on a rolling basis beginning at the start of 2023.** With the phases and priorities laid out above, LGP will aim to make a significant impact by catalyzing growth and innovation in the LUX ecosystem.

**This program is meant to be the simplest possible MVP of a Lux Ecosystem Grants Initiative.** While the multi-sig committee comes with trust assumptions about the members, our hope is the community will approve this limited engagement to get the ball rolling in an efficient structure. **After the first epoch (2 fiscal quarters) the burden of proof will be on Lux DAO to show empirical evidence that the program is worth continuing in its existing form and will submit to governance to renew treasury funding.**
