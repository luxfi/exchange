...
import { BackArrowIcon, ChevronUpIcon, LightningBoltIcon, TwitterIcon, LuxIcon } from 'nft/components/icons'
            ...
            {showPurchasedModal && (
              ...
              >
                <Box className={styles.successModal} onClick={stopPropagation}>
                  <LuxIcon color={vars.color.white} width="36" height="36" className={styles.uniLogo} />
                  <Box display="flex" flexWrap="wrap" width="full" height="min">
                    <h1 className={styles.title}>
                      <Trans>Complete!</Trans>
                    </h1>
                    <p className={styles.subHeading}>
                      <Trans>Lux has granted your wish!</Trans>
                    </p>
                  </Box>
                ...
                >
                  <Box className={styles.fullRefundModal} onClick={stopPropagation}>
                    ...
                    <p className={styles.bodySmall}>
                      ...
                      please visit our <a href="https://discord.gg/6WHnbNnzVb">Discord</a>
                    </p>
