    ...
    <CarouselCardBorder>
      <CarouselCardContainer onClick={onClick}>
        ...
        <CardBottomContainer>
          <>
            <TableElement>
              <MarketplaceIcon src="/nft/svgs/marketplaces/uniswap-magenta.svg" alt="Lux icon" />
              <FirstColumnTextWrapper>
                <ThemedText.SubHeaderSmall color="userThemeColor">Lux</ThemedText.SubHeaderSmall>
              </FirstColumnTextWrapper>
            </TableElement>
            <TableElement>
