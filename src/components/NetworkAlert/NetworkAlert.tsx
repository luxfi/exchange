...
const BG_COLORS_BY_DARK_MODE_AND_CHAIN_ID: {
  ...
  dark: {
    ...
    [SupportedChainId.BLAST]:
      'radial-gradient(182.71% 150.59% at 2.81% 7.69%, rgba(220, 220, 10, 0.25) 0%, rgba(240, 240, 100, 0.15) 100%)',
  ...
  light: {
    ...
    [SupportedChainId.POLYGON_MUMBAI]:
      'radial-gradient(182.71% 205.59% at 2.81% 7.69%, rgba(130, 71, 229, 0.2) 0%, rgba(167, 202, 255, 0.2) 100%)',
    [SupportedChainId.BLAST]:
      'radial-gradient(182.71% 150.59% at 2.81% 7.69%, rgba(220, 220, 10, 0.15) 0%, rgba(240, 240, 100, 0.15) 100%)',
    [SupportedChainId.BNB]:
