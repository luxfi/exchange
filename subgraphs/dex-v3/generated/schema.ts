...
export class Bundle extends Entity {
  ...
  get luxPriceUSD(): BigDecimal {
    let value = this.get("luxPriceUSD");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set luxPriceUSD(value: BigDecimal) {
    this.set("luxPriceUSD", Value.fromBigDecimal(value));
  }
}
...
export class Token extends Entity {
  ...
  get tokenHourData(): TokenHourDataLoader {
